...
nominatim_apk   := build/outputs/apk/release/NominatimGeocoderBackend-release-unsigned.apk
...
$(nominatim_root)/$(nominatim_apk):
	...
	cd $(nominatim_root) && JAVA_TOOL_OPTIONS="$(JAVA_TOOL_OPTIONS) -Dfile.encoding=UTF8" ./gradlew --stacktrace assembleRelease
